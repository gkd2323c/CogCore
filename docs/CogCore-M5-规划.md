...
|--------|------|------------|----------|---------|
| **M5.1** 单进程部署 | L9 | 是 | `python -m cogcore serve` CLI + 热重载 + 数据目录 | ✅ 完成 (10 测试) |
| **M5.2** JWT + slowapi | L9 | 否 | JWT 签发/校验 + 速率限制 + 结构化日志 | ✅ 完成 (12 测试) |
| **M5.3** 5 业务场景 | L1 | 是 | 人工干预 + 多 Agent 协作 + 长期陪伴 | ✅ 完成 (22 测试) |
| **M5.4** 实验 E24-E25 | 实验 | 否 | 多模态感受器 + 叙事质量盲评 | ✅ 完成 (11 测试) |
